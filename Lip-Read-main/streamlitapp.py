...
base_path = r"C:\Users\Vinay\OneDrive\Desktop\lipreading\data\s1"
...
if options:
    ...
    with col1:
        ...
        ffmpeg_path = r'C:\Users\Vinay\OneDrive\Desktop\ffm\ffmpeg.exe'  # Replace with the actual path to ffmpeg.exe
        conversion_command = f'"{ffmpeg_path}" -i "{file_path}" -vcodec libx264 "{output_video_path}" -y'
    ...
    with col2:
        ...
        zip_file_path = r'C:\Users\Vinay\OneDrive\Desktop\lipreading\models - checkpoint 50.zip.zip'
